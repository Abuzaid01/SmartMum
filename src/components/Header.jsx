...
const Header = () => {
  ...
  return (
    ...
    <header className='fixed top-0 left-0 pt-3 w-full z-70 opacity bg-blue-100 text-blue-950  '>
      <nav className='flex justify-between items-center max-w-6xl mx-auto p-4'>
        {/* Logo */}
        <div className='justify-items-start '>
          <h1 className='text-xl text-black-700 hover:to-blue-400 font-bold my-auto  inline-block '>
            <a href='#home'>
              <img
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className='md:hidden bg-blue-100 border-t shadow-lg flex flex-col p-4 overflow-hidden w-full '>
